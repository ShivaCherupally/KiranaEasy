...
import kotlinx.android.synthetic.main.ordersuccess.*
...
class OrderSuccessFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.ordersuccess, container, false)
    }
...
//            requireActivity().finish()
    ...
    companion object {
        ...
        fun newInstance(param1: String?, param2: String?): OrderSuccessFragment {
