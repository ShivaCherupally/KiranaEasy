...
//                }
//                Log.d("ServiceChatNotification", "serviceType @ "+ serviceType);
//                if (serviceType != null && serviceType.equalsIgnoreCase("uncaughtException")) {
//                    Common.getInstance().cusToastLong(context, bundle.getString(Constants.NOTIFICATION_OBJECT, ""));
//                } else if (serviceType != null && serviceType.equalsIgnoreCase(Constants.NOTIFICATION_APP_UPDATE)) {
...
//                    Log.d("serviceType", serviceType + "For Call");
//                    return;
//                }
...
//                    Common.getInstance().bringCallActivityToFront(context);
//
